...
export const RMQ_NOTES_CLIENT_ID = "crm_rabbitmq_notes_client_id";
export const RMQ_NOTES_QUEUE = "crm_notes_queue";

export const RMQ_TASKS_CLIENT_ID = "crm_rabbitmq_tasks_client_id";
export const RMQ_TASKS_QUEUE = "crm_tasks_queue";

export const RMQ_AUTH_CLIENT_ID = "crm_rabbitmq_auth_client_id";
export const RMQ_AUTH_QUEUE = "crm_auth_queue";

export const JWT_SECRET = "jwt_key_example";
